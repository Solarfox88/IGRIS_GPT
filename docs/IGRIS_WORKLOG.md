...
| 2026-08-17 | #1355/CI | Devin | Block 36: CI health fix. Fixed 7 pyright errors (json undefined, subprocess→_sp, Optional narrowing) + 1 test failure (RuntimeError in conversation_memory persist). pyright: 7→0 errors. VM: 15/15 gauntlet, 153 tests passed | 15/15 VM | (pending merge) |
