...
| 2026-08-20 | #1353 | Devin | Phase 9: narrow 103 except Exception to specific types (179→76). 75 boundaries annotated # noqa: BLE001, 1 docstring false positive, 0 narrowable remaining, 0 except Exception: pass. Fixed 22 test regressions (RuntimeError added to 16 fail-open boundaries, subprocess import fix, ValueError for decision_memory). Ubuntu migration: HP firmware CPU throttle bypassed (intel_pstate 3.6GHz). VM migrated from Hyper-V to KVM/QEMU (VHDX EFI boot failed, fresh cloud image created). compileall PASS, pytest 7069 passed/2 skipped/0 failed, VM gauntlet 15/15, diagnostics healthy=true, os/brief ok=true | 7069/7071 host, 15/15 VM | (pending merge) |
