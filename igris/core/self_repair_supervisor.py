...
class SelfRepairSupervisor:
    ...
    def _maybe_api_escalate(
        ...
        *,
        ...
        from igris.core.supervisor_autorun_escalation import maybe_api_escalate
        return maybe_api_escalate(self, run, config, failure=failure, cycle=cycle, stage_statuses=stage_statuses)
    ...
    def _autorun_guards(
        ...
        Delegated to igris.core.supervisor_autorun_escalation.autorun_guards
        (Issue #1371 extraction).
        """
        from igris.core.supervisor_autorun_escalation import autorun_guards
        return autorun_guards(self, run, config, decomposition, created_urls)
    ...
    def _autorun_first_subissue(
        ...
        Delegated to igris.core.supervisor_autorun_escalation.autorun_first_subissue
        (Issue #1371 extraction).
        """
        from igris.core.supervisor_autorun_escalation import autorun_first_subissue
        return autorun_first_subissue(self, run, config, decomposition, created_urls, triggering_signal)
